  ...
  window.onload=function () {
    ...
    selectState.addEventListener('change',function(e){
        ...
        data.states.forEach((detail,index)=> {
            ...
            // selectDistrict.appendChild(createOption(value.state, value.state));
            if(detail.state==e.target.value){
                selectDistrict.innerHTML="";
                selectDistrict.append( createOption('Select District',""));
                data.states[index].districts.forEach((districts) => {
                    selectDistrict.append(createOption(districts,districts));
                })
